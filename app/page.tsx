    ...
    <main>
        ...
        <div className="service-grid">
          ...
          <article className="service-card service-card-light" id="hotel">
            ...
            <div>
              ...
              <h3>Зоо-отель</h3>
              <p>Комфортное размещение кошек и грызунов с внимательным присмотром. Собак на проживание не принимаем.</p>
      ...
      <section className="hotel-story" aria-labelledby="hotel-title">
        <div className="hotel-copy">
          <p className="eyebrow">Зоо-отель для кошек и грызунов</p>
          <h2 id="hotel-title">Спокойное место для маленьких гостей</h2>
          <p>
            Принимаем на проживание кошек и домашних грызунов. Перед заселением уточним режим,
            питание и особенности характера. Собак в зоо-отеле не размещаем.
          </p>
